...
export default function HelpClient({ params }: PageProps) {
      ...
      <div className="bg-secondary/20 rounded-2xl border border-border/40 p-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
        ...
        <Link 
          ...
          onClick={(e) => {
            e.preventDefault();
            triggerModal(
              "Support Desk Simulated",
              "Under our v1.0 philosophy, direct inquiries can be routed to support@love-sync.com. Premium members receive 2-hour Priority SLA responses.",
              "success"
            );
          }}
